...
namespace FGP.States
{
    public class Win : State
    {
        ...
        public Win(Game1 game, GraphicsDevice graphicsDevice, ContentManager content)
          : base(game, graphicsDevice, content)
        {
            var buttonTexture = _content.Load<Texture2D>("Menus/Button");
            var buttonFont = _content.Load<SpriteFont>("Fonts/timerFont");
            winBackground = _content.Load<Texture2D>("Menus/You Won!");
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(winBackground, new Vector2(0, -60), Color.White); // Draws the main menu background onto the screen
